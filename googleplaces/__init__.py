...
class GooglePlaces(object):
    ...
    def query(self, location=None, lat_lng=None, keyword=None, radius=3200,
              sensor=False, types=[], name=None, language=None):
        ...
        name     -- A term to be matched against the names of Places.
                    Results will be restricted to those containing
                    the passed name value (default None)
        language -- The language code, indicating in which language the results
                    should be returned, if possible (default None)
        """
